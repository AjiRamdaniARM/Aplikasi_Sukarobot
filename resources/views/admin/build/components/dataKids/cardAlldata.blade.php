<div class="flex flex-wrap -mx-5 " style="gap: 10px">
                ...
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal">Semua Data</p>
    ...
    @foreach ($getClassProgram as $class )
     {{-- component card database --}}
    <div class="w-full max-w-full scale-custom px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
        <a href="{{ route('index.kids', ['keyword' => $class->id]) }}" class="hover:scale-105">
            <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="flex-auto p-4">
                    <div class="flex flex-row -mx-3">
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                <p class="mb-0 font-sans text-sm font-semibold leading-normal">{{$class->kelas}}</p>
                                <h5 class="mb-0 font-bold">
                                    {{ $class->siswa_count }}
                                    <span class="text-sm leading-nsaormal font-weight-bolder text-lime-500">Siswa</span>
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
