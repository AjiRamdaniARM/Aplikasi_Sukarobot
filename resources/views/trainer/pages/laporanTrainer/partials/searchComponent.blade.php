        ...
        <div class="md:flex">
            <div class="w-full py-4">
              <div class="relative">
                ...
                <button id="buttonPopover" class="absolute top-4 right-5 border-l pl-4"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<script>
    const buttonPopover = document.getElementById('buttonPopover');
    buttonPopover.addEventListener('click', () => {
        alert('pencarian data laporan mengajar mencakup ( nama kelas, nama level , hari, tanggal mengajar, bulan mengajar dan tahun mengajar )');
    });
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script>
    // === sistem fitur search laporan json === //
