                            ...
                            <div class="flex-auto p-4">
                                ...
                                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                    <li
                                        ...
                                        <strong class="text-slate-700">Place of Birth:</strong> &nbsp;
                                        {{ $getSiswa->tl }}
                                    </li>
                                    <li
                                        class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                        <strong class="text-slate-700">Date of Birth :</strong> &nbsp;
                                        {{ $getSiswa->tanggal_lahir }}
                                    </li>
                                    <li
                                        class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                        <strong class="text-slate-700">Class :</strong> &nbsp;
                                        {{ $getSiswa->kelas }}
                                    </li>
                                    <li
                                        class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                        <strong class="text-slate-700">Parent's Name :</strong> &nbsp;
                                        {{ $getSiswa->nama_ortu }}
                                    </li>
                                    <li
                                        class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                        <strong class="text-slate-700">Parent's Occupation :</strong> &nbsp;
                                        {{ $getSiswa->work_ortu }}
                                    </li>

                                    <li
                                        class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                        <strong class="text-slate-700">Phone Number :</strong> &nbsp;
                                        {{ $getSiswa->telephone }}
                                    </li>
