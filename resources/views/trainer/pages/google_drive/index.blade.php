...
<div x-data="{ show: false }">
  <button @click="show = !show" class="mt-4 ml-6 px-4 py-2 bg-[#4F46E5] hover:scale-105 hover:bg-[#7D77FFFF] text-white rounded-2xl">
    Drive Auto / Manual
  </button>
  
  <section x-show="!show" class="main-gg-drive">
  ...
  <div x-show="show" x-transition class="mt-4 ml-6">
    <div class="block w-full overflow-x-auto  border">
      <table class="items-center w-full bg-transparent border-collapse border-1 border-black rounded-2xl">
          <thead>
              <tr>
                  <th
