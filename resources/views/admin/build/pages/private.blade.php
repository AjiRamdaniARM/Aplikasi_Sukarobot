                ...
                <div
                    ...
                    <div class="flex flex-wrap -mx-3">
                        ...
                        <div class="flex-none w-auto max-w-full px-3 my-auto">
                            <div class="h-full">
                                <h5 class="mb-1">{{ $getTrainerData->nama }}</h5>
                                <p class="mb-0 font-semibold leading-normal text-sm">Trainer</p>
                            </div>
                        </div>
                        <div
                ...
                <div class="flex flex-wrap justify-center -mx-3">
                    <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-4/12">
                        <div
                            ...
                            <div class="flex-auto p-4">
                                <p class="leading-normal text-sm">{{ $getTrainerData->alamat }}</p>
                                <hr
                                ...
                                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                    ...
                                    @include('admin.build.components.trainer.modalTrainer')
                                    <li
                                        class="relative block px-4 py-2 pl-0 leading-normal bg-white border-0 border-t-0 text-sm text-inherit">
                                        <strong class="text-slate-700">Email:</strong> &nbsp;
                                        {{ $getTrainerData->email }} <span><button
                                                onclick="window.modalEmail{{ $getTrainerData->id }}.showModal();"
                    ...
                    <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-4/12">
                        <div
                            class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
                            <div class="p-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
                                <h6 class="mb-0">Confidential Data</h6>
                            </div>
                            <div class="flex-auto p-4">
                                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                                    ...
                                    <li
                                        ...
                                        <div
                                            ...
                                            <img src="{{ asset('assets/trainer_data/ktp/' . $getTrainerData->ktp_file) }}"
                                                alt="kal" class="w-full shadow-soft-2xl rounded-xl" />
                                        </div>
                                        <div class="flex flex-col items-start justify-center">
                                            <h6 class="mb-0 leading-normal text-sm">Image KTP </h6>
                                            <p class="mb-0 leading-tight text-xs">Data penting jangan di bagikan</p>
                                        </div>
                                        <a class="inline-block py-3 pl-0 pr-4 mb-0 ml-auto font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-xs ease-soft-in hover:scale-102 hover:active:scale-102 active:opacity-85 text-fuchsia-500 hover:text-fuchsia-800 hover:shadow-none active:scale-100"
                                            href="{{ asset('assets/trainer_data/ktp/' . $getTrainerData->ktp_file) }}">View</a>
                                    </li>
                                    <li
                                        class="relative flex items-center px-0 py-2 mb-2 bg-white border-0 border-t-0 text-inherit">
                                        <div
                                            class="inline-flex items-center justify-center w-12 h-12 mr-4 text-white transition-all duration-200 text-base ease-soft-in-out rounded-xl">
                                            <img src="{{ asset('assets/trainer_data/ttd/' . $getTrainerData->ttd) }}"
                                                alt="kal" class="w-full shadow-soft-2xl rounded-xl" />
                                        </div>
                                        <div class="flex flex-col items-start justify-center">
                                            <h6 class="mb-0 leading-normal text-sm">Image TTD</h6>
                                            <p class="mb-0 leading-tight text-xs">Data penting jangan di bagikan</p>
                                        </div>
                                        <a class="inline-block py-3 pl-0 pr-4 mb-0 ml-auto font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer leading-pro text-xs ease-soft-in hover:scale-102 hover:active:scale-102 active:opacity-85 text-fuchsia-500 hover:text-fuchsia-800 hover:shadow-none active:scale-100"
                                            href="{{ asset('assets/trainer_data/ttd/' . $getTrainerData->ttd) }}">View</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
