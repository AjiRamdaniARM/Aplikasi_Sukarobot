<dialog id="modalDrive">
  <h2 class="poppins-bold">Folder Drive</h2>
  <form action="{{route('menu.googleDrive.post')}}" method="POST">
    @csrf
    ...
    <div class="voucher-code-container-admin">
      ...
      <input type="text" name="name_folder" class="voucher-input p-4" required>
    </div>

    <div class="voucher-code-container-admin">
      <h6 class="voucher-code-title-admin">Link Folder</h6>
      <input type="text" name="link_folder" class="voucher-input p-4" required>
    </div>

    <button type="submit" class="voucher-button-admin">Create</button>
  </form>
	<button  aria-label="close" onclick="window.modalDrive.close();" class="x">❌</button>
</dialog>
